...
class LocalFooterCest {
   ...
   */
  public function ___testCustomLocalFooter(AcceptanceTester $I) {
    $I->logInWithRole('site_manager');
    $I->amOnPage('/admin/config/system/local-footer');
   ...
   * Content blocks.
   */
  public function ___testCustomContentLocalFooter(AcceptanceTester $I) {
   ...
   */
  public function ___testNodeRoutesAndNoLink(AcceptanceTester $I) {
    $node = $I->createEntity([
      'type' => 'stanford_page',
      'title' => 'Test Page',
    ]);
